...
st.title("Real EZ Scheduler: Full Tour Optimizer with Agent Messaging")

st.markdown("Enter up to 10 properties, rank them by priority (1 = highest), and optimize your route using Google Maps.")

# Travel mode selection
travel_mode = st.radio("Select Tour Mode", ["driving", "walking"], horizontal=True)

# Input for property info
